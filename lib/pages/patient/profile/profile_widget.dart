...
import '/pages/patient/edit_profile_modal/edit_profile_modal_widget.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => Text(
                    valueOrDefault(currentUserDocument?.about, '') == null ||
                            valueOrDefault(currentUserDocument?.about, '') == ''
                        ? 'Mention something you like to share.'
                        : valueOrDefault(currentUserDocument?.about, ''),
                    style: FlutterFlowTheme.of(context).titleSmall.override(
                          fontFamily: 'Inter Tight',
                          color: FlutterFlowTheme.of(context).accent4,
                        ...
                        Container(
                          ...
                          child: Align(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => Text(
                                functions
                                    .getAge(currentUserDocument!.dob!)
                                    .toString(),
